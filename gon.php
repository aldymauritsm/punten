...
echo color("red","[]  Created By \n");
echo color("nevy","[]  Emboh Gak Eroh \n");
echo color("blue","[] PAIDOMU MOTIVASIKU  \n");
echo color("green","[] JANGAN LUPA BERDOA SEBELUM CLAIM \n");
echo color("blue","[] JANGAN KASIH KENDOR \n");
echo color("red","# # # # # # # # # # # # # # # # # # # # # # # \n");
        $nama = nama();
...
$token = trim(fgets(STDIN));
        echo "\n".color("green","👌🍱 Ambil Voucer Go-Food 20k ");
        ...
        for($a=1;$a<=3;$a++)
{
        ...
        $code1 = requestedd('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PESANGOFOOD1908"}');
        ...
        $expired13 = getStr23('"expiry_date":"','"',$cekvoucher,'13');
         ...
         echo color("white","▬▬▬▬▬▬▬▬▬▬▬▬▬▬ PIN MU = 181818 ▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"181818"}';
